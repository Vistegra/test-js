...
Требуется разделить страницу на две части (вертикально или горизонтально, как удобно). В одной части каталог товаров, во второй - корзина. Пример [тут](https://github.com/Vistegra/test-js/blob/master/result.JPG)
