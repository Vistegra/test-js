...
- Элемент каталога содержит:
  * Название товара, плюс для товаров с торговыми предложениями любой характеристики.\ Например: Штакетник RAL 8017 длина 1500 толщина 0.45.
  * Цена;
...
- Стиль программирования (процедурный, функциональный, ООП)
...
- Каталог с фильтром (например по свойству TYPE и/или WIDTH).
